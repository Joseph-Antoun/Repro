...
from experiment2_save_data import save_data, save_posteriors, save_true_params
from experiment2_plots import plot_posterior_params, plot_runtimes
...
def run_experiments(methods):
    ...
    for N in [10, 100, 1000, 10000, 50000, 100000, 500000, 1000000]:
...
def plot_experiments(methods):
    ...
    plot_posterior_params(params_means, "./figures/posterior_params.png")

    # Plot the runtimes for this particular experiment
    plot_runtimes(pd.concat(runtimes_lst, axis=0), "./figures/runtimes.png")
